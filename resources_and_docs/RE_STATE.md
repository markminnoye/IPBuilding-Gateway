...
- **Dimmer heeft GEEN on-demand statuspoll (2026-06-12, live getest):** in tegenstelling tot de relay bestaat er voor de dimmer (`10.10.1.40`) geen werkend per-kanaal statusmechanisme. **H1 verworpen:** `I<CH>00` (relay-analogie) selecteert geen kanaal — elke query (`I0000`..`I0700`) gaf identiek `I0154099` (kanaal 0), Bureau (ch1, fysiek gedimd op testmoment) verscheen nooit. **H2 verworpen:** `I9900` blijft altijd `I0154999` (idle), ook met 2 kanalen fysiek actief (Woonkamer vol aan, Bureau gedimd) — 10× herhaald, geen variatie. **Consequentie:** dimmer-niveau is alleen kenbaar via spontane `I0154<ch><vv>`-reply (na commando of fysieke bediening) of eigen state-tracking in de gateway; bij cold restart is het niveau onbekend tot de eerste wijziging. Evidence: [2026-06-12_dimmer_status_poll_hypotheses_refuted.md](evidence/2026-06-12_dimmer_status_poll_hypotheses_refuted.md).
