...
Poort blijft typisch `**30200`**.
  - **IPBuilding-VLAN (veldbus / hub):** host `10.10.1.1` (zoals in `IPBUILDING_KNOWLEDGE.md` §3).
  - **Thuis-LAN `192.168.1.0/24` (REST naar IPBox):** host uit je router — zelfde fysieke IPBox, andere NIC; poort **`30200`**. Oudere voorbeeldwaarde in repo: `192.168.0.185` (ander segment).
