...
- [context-policy.md](context-policy.md) — T0/T1/T2/T3, MCP-gebruik

## Specificaties (`superpowers/specs/`)
...
## Veld-bus & captures (buiten `docs/`)

- [../resources_and_docs/RE_STATE.md](../resources_and_docs/RE_STATE.md)
- [../resources_and_docs/README.md](../resources_and_docs/README.md) — volledige index
- [../resources_and_docs/REORGANIZE_BRIEF.md](../resources_and_docs/REORGANIZE_BRIEF.md) — doc-reorganisatie (**DONE** 2026-05-22)
